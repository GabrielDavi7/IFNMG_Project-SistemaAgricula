...
import { ArrowLeft, Save, Upload, CheckCircle2, Sprout } from "lucide-react";
...
// --- 2. TELA DE REGISTRO DE PLANTIO ---
interface RegisterPlantingProps {
  onNavigate: (page: string) => void;
}

export function RegisterPlanting({ onNavigate }: RegisterPlantingProps) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8 animate-fade-in">
      <SuccessModal
        ...
        message="O novo ciclo de cultura foi registrado com sucesso."
      />
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="px-8 py-6 border-b border-gray-200 bg-[#93a42a]/10">
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-xl font-bold text-gray-900">Novo Plantio</h1>
          </div>
          <p className="text-gray-500 text-sm ml-11">
            Registre o início de uma nova safra ou cultura.
          </p>
        </div>
        ...
        <form onSubmit={handleSave} className="p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                type="text"
                className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#93a42a] outline-none"
                placeholder="Ex: Talhão 05 - Norte"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
          ...
          {/* Upload de Nota Fiscal / Sementes */}
          <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 flex flex-col items-center justify-center text-gray-500 hover:bg-gray-50 cursor-pointer transition-colors group">
            <Upload className="w-8 h-8 mb-2 text-gray-400 group-hover:text-[#93a42a]" />
            <span className="text-sm font-medium">
              Anexar Nota Fiscal de Sementes (Opcional)
            </span>
          </div>
